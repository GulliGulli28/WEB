...
<body>
    <h1>Register</h1>
    <form action="/app/views/inc/navbar.php" method="post">
        ...
        <label for="confirm_password" class="form-label">Confirm Mot de passe</label>
        <input type="password" id="confirm_password" name="confirm_password"
            class="form-controll mb-3 d-flex flex-column">
